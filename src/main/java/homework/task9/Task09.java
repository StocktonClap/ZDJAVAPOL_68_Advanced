...
public class Task09 {
    public static void main(String[] args) {
     ...
     //   board.markAt(newMark, 0,2);                   //po wykonaniu zadania usuń ten wiersz
      ...
      //  GameBoard.PlayerMark newMark = new GameBoard.PlayerMark("Michał", "7");
      //  board.markAt(newMark, 0, 2);
       // GameBoard.PlayerMark = new GameBoard.PlayerMark("2", "3");

        GameBoard.PlayerMark newMark = new GameBoard.PlayerMark("Hello", "a");
