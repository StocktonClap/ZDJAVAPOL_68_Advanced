...
/**
 * Napisz program, który pobiera jednocześnie kilka plików graficznych. Każdy plik ma być pobierany w osobnym wątku.
 * Gdy ostani plik zostanie pobrany i zapisany program kończy działanie.
 * Przykąłdowe adresy plików:
